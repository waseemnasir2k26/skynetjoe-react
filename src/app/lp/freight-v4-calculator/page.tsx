        ...
        <section className="section" id="pricing">
          <div className="section-inner">
            ...
            <table className="tier-table">
              ...
              <tbody>
                <tr><td>Starter<small style={{ display: "block", color: "var(--text-faint)", fontSize: 11, fontWeight: 400 }}>site + CRM + WA inbox</small></td><td><span className="price">$1,497</span><span className="ship">flat · no monthly</span></td><td>14d</td><td>5-page premium site, GHL CRM, Signal inbox, Meta Pixel + CAPI, 2 revisions.</td><td><a href="/discovery-call">start →</a></td></tr>
        ...
        <section className="section">
          <div className="section-inner">
            ...
            <div className="faq-list">
              <details className="faq-item"><summary>I only have 5 trucks. Is this overkill?</summary><p>Starter ($1,497) is built for 5–10. Site + CRM + Signal inbox in 14 days. No retainer. Cancel anytime, walk with the build.</p></details>
