...
// Service JSON-LD — the missed-call recovery bundle offered on this lander.
// Factual: provider, what it is, who it serves. No fabricated ratings/prices.
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Missed-call recovery for home-services businesses",
  serviceType:
    "Missed-call text-back, Google Business Profile, and 1-page site",
  description:
    "SkynetLabs answers and texts back every missed call 24/7, cleans up the Google Business Profile, and builds a fast 1-page site for Texas HVAC and plumbing businesses — so jobs stop going to the competitor who picked up.",
  provider: {
    "@type": "Organization",
    name: SITE.brand,
    url: SITE.url,
  ...
  audience: {
    "@type": "Audience",
    audienceType: "Texas HVAC and plumbing business owners",
  },
  url: PAGE_URL,
};
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "No. We work with the number you already use. Nothing changes for your callers except that they finally get a reply.",
      },
    },
    {
      "@type": "Question",
      name: "Is this hard to set up?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Not for you. We do the whole setup. You answer a few quick questions and keep running your business. It is live within a week.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "How many calls you missed last month, when they came in, and a dollar estimate of the work that likely walked away. No strings.",
      },
    },
    {
      "@type": "Question",
      name: "What if I am too busy to deal with this right now?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "That is exactly when calls get missed the most. The audit takes you two minutes to request and we handle the rest.",
      },
    },
  ],
};
      ...
      <section className="hs-section" id="leak">
        ...
        <div className="hs-stats">
          ...
          <div className="hs-stat">
            ...
            <p>
              of customers hire whoever answers first, not the cheapest bid.
            </p>
          </div>
        </div>
      </section>
