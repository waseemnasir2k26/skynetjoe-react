...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "EU logistics, Northeast recovery network, Bali wellness, KSA retail and more — anonymized where contracts require it.",
...
const schema = {
  ...
  description:
    "Eight anonymized client wins across automation, websites, AEO content engines and CRM rebuilds.",
  url: `${SITE.url}/case-studies`,
  inLanguage: "en",
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            EU logistics. US recovery network. Bali wellness. KSA retail. Each
            one anonymized where the contract requires it — outcomes, stack, and
      ...
      >
        ...
        >
          ...
          >
            8 builds shipped. Limited slots each month. 30-min call decides if
