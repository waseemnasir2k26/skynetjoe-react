  ...
  return (
    <>
      ...
      >
        ...
        <p>
          For SkynetLabs client work, where the build is $4,000–$9,500 and the
          timeline is 14–45 days, the speedup collapses into earlier delivery
          and the ability to handle more concurrent retainers without adding
          headcount. The math isn&apos;t &quot;Claude Code replaces a
          developer.&quot; It&apos;s &quot;Claude Code lets one operator
          credibly deliver what used to require three.&quot;
        </p>
        ...
        <p>
          First, the Starter tier ship window drops from 14 days to 10 days,
          same price. The math is honest — the work that used to take 14 days
          now takes 10 because the agent compresses the boring middle. I&apos;m
          passing the savings on as faster ship rather than lower price, because
          faster ship is what clients actually want.
        </p>
        <p>
