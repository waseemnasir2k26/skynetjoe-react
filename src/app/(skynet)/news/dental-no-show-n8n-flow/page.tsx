    ...
    <>
      ...
      >
        ...
        <p>
          ...
          watches for appointment creation, schedules four touch points across
          the booking window, sends each one through Signal Cloud API, listens
          for the patient&apos;s reply, branches based on the response, and
          writes the outcome back to GHL. The front desk gets one daily Slack
          digest at 8am: who confirmed, who cancelled, who we need to call.
        </p>
...
2. ...`}</code>
        ...
        <p>
          ...
          aesthetics, physiotherapy. The base template is now $2,997 for a
          10-day ship including Signal setup, GHL pipeline mapping, four
          template approvals, the n8n graph, and a handoff Loom for your front
          desk.
        </p>
        <p>
