...
export const metadata: Metadata = {
  ...
  description:
    "Book a free 30-minute audit with Waseem Nasir. Get 3 concrete plays to plug revenue leaks plus a fixed-price scope in 48 hours. No SDR, no pitch deck — just a working roadmap.",
