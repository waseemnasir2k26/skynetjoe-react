...
/* ============================================================
   ...
   Ported verbatim from waseemnasir-react's aicity-signalgrid/
   CameraPath.ts — waypoints for SIGNALGRID's 6 scenes: ENTRY /
   GRID / TOWER FLYBYS / PROOF SUBSTATION / WORKS BOULEVARD /
   UPLINK. Near-static hero, overhead lift into the grid, a
   street-grazing dolly past the service blocks, then a pull-out
