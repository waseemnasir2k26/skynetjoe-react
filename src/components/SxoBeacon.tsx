...
// the beacon is disclosed on /privacy-policy (name, fields, recipient host). Honors
...
// always a hard load (Calendly embed pages are hard loads), so the conversion page is
// counted correctly.
const SITE = "skynetjoe";
