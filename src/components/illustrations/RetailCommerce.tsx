  ...
  return (
    ...
    >
      ...
      <g opacity="0.18" fill="#fff">
        ...
        <rect x="22" y="146" width="18" height="18" rx="3" transform="rotate(15 31 155)" />
      </g>
      ...
      <g transform="translate(34 30)">
        ...
        <text x="126" y="14" textAnchor="middle" fontFamily="system-ui,sans-serif" fontSize="9" fontWeight="800" fill="#0F2F2A" letterSpacing="1">
          BOUTIQUE · RIYADH
        </text>
      </g>
      ...
      <g transform="translate(34 64)">
        {[0, 1, 2].map((i) => (
          <g key={i} transform={`translate(${i * 64} 0)`}>
            ...
            <rect x="4" y="4" width="48" height="36" rx="3" fill="#5EEAD4" opacity="0.5" />
            {/* product silhouette */}
            <path
              ...
              opacity="0.65"
            />
            <rect x="6" y="44" width="36" height="4" rx="1.5" fill="#0F2F2A" opacity="0.7" />
            <rect x="6" y="51" width="22" height="3" rx="1" fill="#0F2F2A" opacity="0.45" />
            <rect x="6" y="58" width="44" height="6" rx="2" fill="#14B8A6" />
            <text x="28" y="62.5" textAnchor="middle" fontFamily="system-ui,sans-serif" fontSize="5.5" fontWeight="700" fill="#fff">
              ADD TO CART
            </text>
          </g>
        ))}
      ...
      <g transform="translate(232 64)">
        ...
        <path
          ...
          strokeLinecap="round"
        />
        <text x="29" y="44" textAnchor="middle" fontFamily="system-ui,sans-serif" fontSize="12" fontWeight="900" fill="#0F2F2A" opacity="0.7">
          ع
        </text>
      </g>
      ...
      <g transform="translate(196 138)">
        ...
        {/* chip lines */}
        <line x1="9" y1="13" x2="17" y2="13" stroke="#0F2F2A" strokeWidth="0.5" />
        <line x1="9" y1="16" x2="17" y2="16" stroke="#0F2F2A" strokeWidth="0.5" />
        <line x1="9" y1="19" x2="17" y2="19" stroke="#0F2F2A" strokeWidth="0.5" />
        <text x="26" y="15" fontFamily="system-ui,sans-serif" fontSize="6.5" fill="#5EEAD4" fontWeight="700">
          MADA
        </text>
        <text x="26" y="25" fontFamily="system-ui,sans-serif" fontSize="8" fontWeight="800" fill="#fff">
          47% reply→sale
        </text>
      </g>
      ...
      <g transform="translate(16 138)">
        <path d="M0 0 L 60 0 L 70 14 L 60 28 L 0 28 Z" fill="#FFE07A" opacity="0.95" />
        <circle cx="58" cy="14" r="3" fill="#0F2F2A" />
        <text x="28" y="18" textAnchor="middle" fontFamily="system-ui,sans-serif" fontSize="9" fontWeight="800" fill="#0F2F2A">
          800 SKU
        </text>
      </g>
    </svg>
