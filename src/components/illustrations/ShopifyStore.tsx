...
export default function ShopifyStore({ className }: Props) {
  return (
    ...
    >
      ...
      <rect x="276" y="148" width="14" height="14" rx="3" transform="rotate(20 283 155)" fill="#fff" opacity="0.18" />
      ...
      <g transform="translate(26 48)">
        ...
        <rect width="268" height="84" fill="none" stroke="#A7F3D0" strokeWidth="1" opacity="0.5" />

        {/* "OPEN" sign */}
        <g transform="translate(18 16)">
          <rect width="48" height="20" rx="3" fill="#FF6B6B" />
          <text x="24" y="14" textAnchor="middle" fontFamily="system-ui,sans-serif" fontSize="9" fontWeight="900" fill="#fff" letterSpacing="0.8">
            OPEN
          </text>
        </g>
        ...
        <g transform="translate(82 14)">
          {[0, 1, 2].map((i) => (
            <g key={i} transform={`translate(${i * 64} 0)`}>
              ...
              <rect x="6" y="44" width="44" height="3" rx="1" fill="#064E3B" opacity="0.7" />
              <rect x="6" y="50" width="22" height="4" rx="1.5" fill="#10B981" />
            </g>
          ))}
        </g>
      </g>
      ...
      <g transform="translate(228 96)">
        <path d="M6 14 H 56 L 60 56 A 4 4 0 0 1 56 60 H 6 A 4 4 0 0 1 2 56 Z" fill="url(#shop-bag)" />
        <path d="M16 14 V 8 A 14 14 0 0 1 46 8 V 14" stroke="#064E3B" strokeWidth="2.4" fill="none" strokeLinecap="round" />
        <circle cx="44" cy="36" r="12" fill="#FF6B6B" />
        <text x="44" y="40" textAnchor="middle" fontFamily="system-ui,sans-serif" fontSize="10" fontWeight="900" fill="#fff">
          3
        </text>
      </g>
      ...
      <g transform="translate(28 144)">
        ...
        <path d="M11 13 L 13.5 15.5 L 18 11" stroke="#064E3B" strokeWidth="1.6" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        <text x="26" y="11" fontFamily="system-ui,sans-serif" fontSize="6" fill="#A7F3D0" letterSpacing="0.4">
          MOBILE CVR
        </text>
        <text x="26" y="21" fontFamily="system-ui,sans-serif" fontSize="9" fontWeight="800" fill="#fff">
          +312% in 21d
        </text>
      </g>
    </svg>
