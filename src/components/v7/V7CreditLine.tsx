 ...
 * required "Built by SkynetLabs · waseemnasir.com" credit renders on /v7.
 * Same pattern as src/components/v3/V3CreditLine.tsx.
 */
export default function V7CreditLine() {
  return (
    <div
      style={{
        background: "var(--ink)",
