...
// FIX (2026-06-04): the LETTER_CSS string previously opened with a runtime
// `@import url(fonts.googleapis.com...)` for Lora/Caveat/Inter. That import is
// render-blocking and bypasses Next's next/font optimization (self-hosting +
// preconnect + size-adjust). Wired Lora (serif body) + Caveat (handwritten
// accent) via next/font/google here; their `.variable` CSS vars are attached to
// the .lp-v3 wrapper (see LetterShell). The CSS below now references those vars
// instead of bare 'Lora'/'Caveat' family names. Inter stays on the global
// --font-sans-inter (declared in (skynet)/layout.tsx) which wraps these routes.
const lora = Lora({
  subsets: ["latin"],
  weight: ["400", "500", "600", "700"],
  style: ["normal", "italic"],
  variable: "--font-letter-lora",
  display: "swap",
});
...
const caveat = Caveat({
  subsets: ["latin"],
  weight: ["400", "500", "600", "700"],
  variable: "--font-letter-caveat",
  display: "swap",
});

export const LETTER_CSS = `
.lp-v3 { --paper:#F2EFE6; --paper-2:#EDE8DC; --navy:#1A1A1A; --navy-2:#3A3A36; --ink:#1A1A1A; --gold:#C66B3F; --rule:rgba(26,26,26,0.12); background:var(--paper); color:var(--ink); font-family:var(--font-letter-lora),Georgia,serif; font-size:18px; line-height:1.7; min-height:100vh; }
...
.lp-v3 .hand { font-family:var(--font-letter-caveat),cursive; color:var(--gold); font-weight:500; }
...
.lp-v3 .brand { font-family:var(--font-letter-lora),Georgia,serif; font-weight:600; font-size:19px; letter-spacing:0.01em; text-decoration:none; }
.lp-v3 .brand em { color:var(--gold); font-style:italic; font-weight:500; }
.lp-v3 .nav-cta { font-family:var(--font-sans-inter),Inter,sans-serif; font-size:13px; font-weight:500; padding:9px 18px; background:var(--navy); color:var(--paper); text-decoration:none; border-radius:2px; transition:background 0.18s; }
.lp-v3 .nav-cta:hover { background:var(--gold); color:var(--ink); }
.lp-v3 .hero { padding:80px 0 56px; position:relative; }
.lp-v3 .hero-mark { text-align:center; margin-bottom:32px; font-family:var(--font-sans-inter),Inter,sans-serif; font-size:11px; letter-spacing:0.24em; text-transform:uppercase; color:var(--gold); }
.lp-v3 .hero-mark::before,.lp-v3 .hero-mark::after { content:'·'; margin:0 12px; opacity:0.6; }
.lp-v3 .hero h1 { font-family:var(--font-letter-lora),Georgia,serif; font-weight:500; font-size:clamp(34px,5vw,56px); line-height:1.15; letter-spacing:-0.015em; text-align:center; max-width:22ch; margin:0 auto 32px; }
...
.lp-v3 .hero-photo { width:100%; aspect-ratio:16/10; object-fit:cover; filter:brightness(1.02); }
.lp-v3 .hero-photo-cap { margin-top:12px; text-align:center; font-family:var(--font-letter-caveat),cursive; font-size:22px; color:var(--gold); }
...
.lp-v3 .letter h2 { font-family:var(--font-letter-lora),Georgia,serif; font-weight:600; font-style:italic; font-size:32px; line-height:1.2; letter-spacing:-0.01em; color:var(--navy); margin:56px 0 24px; }
.lp-v3 .letter h2::before { content:'— '; color:var(--gold); }
.lp-v3 .letter h3 { font-family:var(--font-letter-lora),Georgia,serif; font-weight:600; font-size:22px; color:var(--navy); margin:36px 0 14px; }
...
.lp-v3 .letter blockquote cite { display:block; margin-top:12px; font-family:var(--font-sans-inter),Inter,sans-serif; font-style:normal; font-size:13px; letter-spacing:0.06em; color:var(--navy-2); text-transform:uppercase; }
...
.lp-v3 .related-kicker { text-align:center; font-family:var(--font-sans-inter),Inter,sans-serif; font-size:11px; letter-spacing:0.24em; text-transform:uppercase; color:var(--gold); margin-bottom:14px; }
.lp-v3 .related-h { font-family:var(--font-letter-lora),Georgia,serif; font-weight:500; font-style:italic; font-size:clamp(26px,3.5vw,38px); text-align:center; color:var(--navy); margin-bottom:36px; letter-spacing:-0.01em; }
...
.lp-v3 .related-card-meta { font-family:var(--font-sans-inter),Inter,sans-serif; font-size:11px; letter-spacing:0.1em; text-transform:uppercase; color:var(--gold); margin-bottom:10px; }
.lp-v3 .related-card-title { font-family:var(--font-letter-lora),Georgia,serif; font-weight:600; font-size:19px; color:var(--navy); margin-bottom:8px; line-height:1.3; }
...
.lp-v3 .closer h2 { font-family:var(--font-letter-lora),Georgia,serif; font-style:italic; font-weight:500; font-size:clamp(32px,5vw,52px); margin-bottom:24px; letter-spacing:-0.015em; max-width:24ch; margin-left:auto; margin-right:auto; color:var(--ink); }
...
.lp-v3 .btn { font-family:var(--font-sans-inter),Inter,sans-serif; font-size:14px; font-weight:600; letter-spacing:0.04em; padding:14px 24px; text-decoration:none; border-radius:2px; transition:background 0.18s,transform 0.18s,color 0.18s; display:inline-flex; align-items:center; gap:8px; }
...
.lp-v3 .news-foot { padding:48px 0 32px; background:var(--paper-2); border-top:1px solid var(--rule); font-family:var(--font-sans-inter),Inter,sans-serif; font-size:13px; color:var(--navy-2); text-align:center; }
...
.lp-v3 .index-hero h1 { font-family:var(--font-letter-lora),Georgia,serif; font-weight:500; font-size:clamp(40px,6vw,68px); line-height:1.1; letter-spacing:-0.015em; max-width:22ch; margin:0 auto 24px; }
...
.lp-v3 .card-photo img { width:100%; height:100%; object-fit:cover; transition:transform 0.4s; }
...
.lp-v3 .card-meta { font-family:var(--font-sans-inter),Inter,sans-serif; font-size:11px; letter-spacing:0.14em; text-transform:uppercase; color:var(--gold); margin-bottom:10px; }
.lp-v3 .card-title { font-family:var(--font-letter-lora),Georgia,serif; font-weight:600; font-size:22px; color:var(--navy); margin-bottom:10px; line-height:1.25; }
.lp-v3 .card-deck { font-style:italic; color:var(--navy-2); font-size:15px; line-height:1.5; margin-bottom:18px; flex:1; }
.lp-v3 .card-read { font-family:var(--font-letter-caveat),cursive; color:var(--gold); font-size:20px; }
.lp-v3 .wa-sticky { position:fixed; bottom:24px; right:24px; z-index:60; background:var(--gold); color:var(--ink); font-family:var(--font-sans-inter),Inter,sans-serif; font-size:13px; font-weight:600; padding:14px 20px; border-radius:32px; text-decoration:none; box-shadow:0 12px 28px rgba(201,152,90,0.32); display:inline-flex; align-items:center; gap:8px; transition:transform 0.18s; }
...
export function LetterShell({ children }: { children: ReactNode }) {
  return (
    <div className={`lp-v3 ${lora.variable} ${caveat.variable}`}>
