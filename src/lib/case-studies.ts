...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    longFormStory: [
      ...
      "The courier-rate-on-cart was the single highest-leverage decision. Shoppers in KSA had been trained by 5 years of Shopify abandonment to expect a 'surprise' shipping fee at checkout. Surfacing the Aramex rate on the cart page itself cut surprise-abandonment to under 3%.",
